...
$packageArgs = @{
  ...
  checksum = '8B7FCD7A92EA9CE7AFEFBE2F562821BDAE40A5E8E7546F90B65CDC8F25F1120D'
  checksumType = 'sha256'
  Url = 'https://gitlab.com/famedly/fluffychat/-/archive/v1.11.2/fluffychat-v1.11.2.zip'
