...
Install-ChocolateyZipPackage -PackageName $packageName -Url 'https://gitlab.com/api/v4/projects/16112282/packages/generic/fluffychat/0.42.0/fluffychat-windows.zip' -UnzipLocation $toolsDir
