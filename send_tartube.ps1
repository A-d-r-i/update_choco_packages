...
Invoke-WebRequest -Uri "https://github.com/axcore/tartube/releases/download/v$tag/install-tartube-$tag-64bit.exe" -OutFile "./$id/tools/tartube64.exe"
...
$TABLE64 = Get-FileHash "./$id/tools/tartube64.exe" -Algorithm SHA256
$SHA64 = $TABLE64.Hash
